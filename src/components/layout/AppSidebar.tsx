    ...
    <Sidebar className="border-r border-slate-200/80 dark:border-slate-800/80">
      ...
      <SidebarFooter className="px-3 py-4 border-t border-slate-200/60 dark:border-slate-800/60">
        <div className="flex items-center gap-3 px-2 py-2 rounded-lg
          hover:bg-slate-100 dark:hover:bg-slate-800/60 transition-colors duration-150 group">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-slate-400 dark:text-slate-600">Conta ativa</p>
          </div>
          <button
